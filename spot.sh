...
#wget http://repository.spotify.com/pool/non-free/s/spotify-client/spotify-client_1.1.67.586.gbb5ef64e_amd64.deb
...
sudo apt-get install git gcc wget curl libcurl4-gnutls-dev rustc
